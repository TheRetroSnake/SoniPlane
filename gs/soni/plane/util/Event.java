            ...
            case E_PROJ:
                return new EventHandler(E_PROJ, priority, string) {
                    ...
                    public void invoke() {
                        ...
                        SP.addToLogicList(new palette());
                        SP.addToLogicList(new plane());
                        SP.addToLogicList(new tileDisp());
                        SP.addToLogicList(new palChange());
                        SP.addToLogicList(new tileEditor());
            ...
            case E_PROJ_LOAD:
                return new EventHandler(E_PROJ_LOAD, priority, string) {
                    ...
                    public void invoke() {
                        ...
                        SP.addToLogicList(new loading(Event.E_PROJ));
                    }
                };
